  ...
  endpoints: (builder) => ({
    getGuestyProperties: builder.query({
      queryFn: async () => {
        try {
          const token =
            "eyJraWQiOiJHdlpFNmFDOGVETHJQTy1kOE9ZRV9SWFB5V1NpN0tKeWI3VjBycEhrTTdRIiwiYWxnIjoiUlMyNTYifQ..cPPEeKdwzDGJp9wW632SyksfSnmaj9no3b89CYsQf9pHOeN6GwM_O073TxOb_fwaBtAC5ng_-zRZYMADJ8D-DJumLFnx_qdT6439toUT5OREkwYsdYoP9fqoIp3mtD_KeTlnKLexSNYMB7DWsw5mINz0I7yR2Iuf_HV6jptCn-ykn97VHpFQJkaPR2bSCm3McKUZoXshw4AL0grk-BdGaT27D__iaiil5t1XpahPmfgdOja-VRb5z78BlxLlOQ2CdSsbYaaUSxDG1KlgT66kw69lvh9KwhFynT4TgsN8-yakBoATgfIzlW8ZhpHuj4sD60ZqPIZsoOKVnkV7qBK3Vg"; // Get the valid token dynamically
          const response = await fetch(
    ...
    getGuestySingleProperty: builder.query({
      queryFn: async (listingId) => {
        try {
          const token =
            "eyJraWQiOiJHdlpFNmFDOGVETHJQTy1kOE9ZRV9SWFB5V1NpN0tKeWI3VjBycEhrTTdRIiwiYWxnIjoiUlMyNTYifQ..cPPEeKdwzDGJp9wW632SyksfSnmaj9no3b89CYsQf9pHOeN6GwM_O073TxOb_fwaBtAC5ng_-zRZYMADJ8D-DJumLFnx_qdT6439toUT5OREkwYsdYoP9fqoIp3mtD_KeTlnKLexSNYMB7DWsw5mINz0I7yR2Iuf_HV6jptCn-ykn97VHpFQJkaPR2bSCm3McKUZoXshw4AL0grk-BdGaT27D__iaiil5t1XpahPmfgdOja-VRb5z78BlxLlOQ2CdSsbYaaUSxDG1KlgT66kw69lvh9KwhFynT4TgsN8-yakBoATgfIzlW8ZhpHuj4sD60ZqPIZsoOKVnkV7qBK3Vg";
